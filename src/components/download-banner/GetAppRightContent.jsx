...
export default function GetAppRightContent() {
  return (
    <motion.div
      ...
      className="flex-1 flex flex-col justify-center gap-4 text-left z-10 py-4 lg:py-2"
    >
      ...
      <motion.div variants={itemVariants} className="flex flex-col gap-1.5">
        ...
        <p className="text-neutral-300/90 text-[0.82rem] sm:text-[0.86rem] leading-relaxed max-w-sm font-body">
          ...
          <div className="w-9 h-9 rounded-xl bg-white p-1 flex items-center justify-center shrink-0">
            <div className="w-full h-full bg-[#050608] rounded-md p-0.5 flex flex-col justify-between">
              <div className="flex justify-between">
                <div className="w-1.5 h-1.5 bg-[#e50914] rounded-xs" />
                <div className="w-1.5 h-1.5 bg-white rounded-xs" />
              </div>
              <div className="w-1 h-1 bg-[#e50914] mx-auto rounded-full animate-ping opacity-75" />
              <div className="flex justify-between">
                <div className="w-1.5 h-1.5 bg-white rounded-xs" />
                <div className="w-1.5 h-1.5 bg-[#e50914] rounded-xs" />
              </div>
