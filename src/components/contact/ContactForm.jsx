        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3.5 py-2.5 rounded-xl bg-black/40 border border-white/10 focus:border-[#FF3B47] text-white text-xs sm:text-sm outline-none transition-colors resize-none"
            />
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 pt-1">
            <button
              type="submit"
              className="w-full sm:flex-1 py-3 px-5 rounded-xl bg-gradient-to-r from-[#E50914] via-[#FF1F2D] to-[#E50914] text-white font-semibold text-xs sm:text-sm flex items-center justify-center gap-2 hover:shadow-[0_4px_20px_rgba(229,9,20,0.4)] transition-all cursor-pointer"
            >
              <Send size={14} />
