  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 p-3.5 sm:p-4 flex flex-col text-left">
        <h3 className="font-heading text-[0.92rem] sm:text-[0.98rem] font-bold text-white tracking-tight uppercase leading-tight drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)]">
          {title}
        </h3>
