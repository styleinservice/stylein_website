...
export default function RecentBlogCard({ blog, index = 0, onSelect }) {
  if (!blog) return null;
    ...
    >
      ...
      <div className="flex-1 p-5 sm:p-5.5 flex flex-col justify-between">
        <div>
          ...
          {/* Title */}
          <h3 className="font-heading font-bold text-white text-[1.02rem] sm:text-[1.08rem] leading-snug line-clamp-2 group-hover:text-white transition-colors mb-2">
            {blog.title}
          </h3>
        ...
        <div className="pt-3 border-t border-white/[0.05] flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-neutral-300 text-[0.74rem] font-medium font-body truncate max-w-[120px]">
